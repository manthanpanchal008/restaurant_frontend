            ...
            <div>
                    ...
                    <div className="container">
                        <div className="row g-5 align-items-center">
                            <div className="col-lg-7 col-md-12">
                                <small className="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-4">Welcome to CaterServ</small>
                                <h1 className="display-1 mb-4">Book <span className="text-primary">Cater</span>Serv For Your Dream Event</h1>
                                <a href className="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5 me-4">Book Now</a>
                                <a href className="btn btn-primary border-0 rounded-pill py-3 px-4 px-md-5">Know More</a>
                            </div>
                            <div className="col-lg-5 col-md-12">
                                <img src="img/hero.png" className="img-fluid rounded" alt />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container-fluid py-6">
                    <div className="container">
                        ...
                        <div className="owl-carousel owl-theme testimonial-carousel testimonial-carousel-1 mb-4">
                        ...
                        <div className="owl-carousel testimonial-carousel testimonial-carousel-2">
                            <div className="testimonial-item rounded bg-light">
                                <div className="d-flex mb-3">
                                    <img src="img/testimonial-1.jpg" className="img-fluid rounded-circle flex-shrink-0" alt />
                                    <div className="position-absolute" style={{ top: 15, right: 20 }}>
